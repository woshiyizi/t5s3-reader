...
#define BQ27220_I2C_ADDRESS (0x55u)
#define BQ27220_I2C_SPEED_HZ_DEFAULT (400000u)
#define BQ27220_I2C_SCL_WAIT_US_DEFAULT (0u)
#define BQ27220_I2C_TIMEOUT_MS_DEFAULT (100)

#define BQ27220_DEVICE_ID (0x0220u)
