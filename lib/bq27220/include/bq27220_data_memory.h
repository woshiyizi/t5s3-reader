...
#define BQ27220_STATIC_ASSERT(cond, msg) static_assert((cond), msg)
#else
#define BQ27220_STATIC_ASSERT(cond, msg) _Static_assert((cond), msg)
#endif
...
BQ27220_STATIC_ASSERT(sizeof(BQ27220DMGaugingConfig) == 2, "Incorrect structure size");
